...
API_ID = int(environ.get('API_ID', '14054590'))
API_HASH = environ.get('API_HASH', '7078713aa84ec6a34c20e4d1a4eb19d3')
BOT_TOKEN = environ.get('BOT_TOKEN', "7245368479:AAGrRXaRSBbCnjEjIv5QZIlm_LIB6ReouyM")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002186994260'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1154056577').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002173926059').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002268990983') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002268990983')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://oct:oct@cluster0.uzp6k.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
